...
public class SC1602TestKC705 {
	...
	public static void main(String... args) throws IOException{
		...
		HDLPort lcd_rs = target.newPort("obj_pLCD_RS", HDLPort.DIR.OUT, HDLPrimitiveType.genBitType(), EnumSet.of(HDLPort.OPTION.NO_SIG));
		HDLPort lcd_e  = target.newPort("obj_pLCD_E",  HDLPort.DIR.OUT, HDLPrimitiveType.genBitType(), EnumSet.of(HDLPort.OPTION.NO_SIG));
		HDLPort lcd_db = target.newPort("obj_pLCD_DB", HDLPort.DIR.OUT, HDLPrimitiveType.genVectorType(4), EnumSet.of(HDLPort.OPTION.NO_SIG));
		HDLPort lcd_rw = target.newPort("obj_pLCD_RW", HDLPort.DIR.OUT, HDLPrimitiveType.genBitType(), EnumSet.of(HDLPort.OPTION.NO_SIG));
