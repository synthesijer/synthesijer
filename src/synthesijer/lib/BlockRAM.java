...
public class BlockRAM extends HDLModule{
	...
	public BlockRAM(int width, int depth, int length){
		...
		newParameter("DEPTH", HDLPrimitiveType.genIntegerType(), String.valueOf(10), String.valueOf(depth));
		newParameter("WORDS", HDLPrimitiveType.genIntegerType(), String.valueOf(1024), String.valueOf(length));
