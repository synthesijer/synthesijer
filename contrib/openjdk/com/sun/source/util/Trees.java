...
import openjdk.com.sun.source.tree.ClassTree;
import openjdk.com.sun.source.tree.CompilationUnitTree;
import openjdk.com.sun.source.tree.MethodTree;
...
public abstract class Trees {
    ...
    public static Trees instance(CompilationTask task) {
        ...
        if (!taskClassName.equals("openjdk.com.sun.tools.javac.api.JavacTaskImpl")
                && !taskClassName.equals("openjdk.com.sun.tools.javac.api.BasicJavacTask"))
    ...
    public static Trees instance(ProcessingEnvironment env) {
        if (!env.getClass().getName().equals("openjdk.com.sun.tools.javac.processing.JavacProcessingEnvironment"))
            throw new IllegalArgumentException();
    ...
    static Trees getJavacTrees(Class<?> argType, Object arg) {
        try {
            ...
            Class<?> c = Class.forName("openjdk.com.sun.tools.javac.api.JavacTrees", false, cl);
