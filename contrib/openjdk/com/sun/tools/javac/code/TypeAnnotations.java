...
import openjdk.com.sun.tools.javac.code.Attribute.TypeCompound;
import openjdk.com.sun.tools.javac.code.Type.AnnotatedType;
import openjdk.com.sun.tools.javac.code.Type.ArrayType;
import openjdk.com.sun.tools.javac.code.Type.CapturedType;
import openjdk.com.sun.tools.javac.code.Type.ClassType;
import openjdk.com.sun.tools.javac.code.Type.ErrorType;
import openjdk.com.sun.tools.javac.code.Type.ForAll;
import openjdk.com.sun.tools.javac.code.Type.MethodType;
import openjdk.com.sun.tools.javac.code.Type.PackageType;
import openjdk.com.sun.tools.javac.code.Type.TypeVar;
import openjdk.com.sun.tools.javac.code.Type.UndetVar;
import openjdk.com.sun.tools.javac.code.Type.Visitor;
import openjdk.com.sun.tools.javac.code.Type.WildcardType;
import openjdk.com.sun.tools.javac.code.TypeAnnotationPosition.TypePathEntry;
import openjdk.com.sun.tools.javac.code.TypeAnnotationPosition.TypePathEntryKind;
import openjdk.com.sun.tools.javac.code.Symbol.VarSymbol;
import openjdk.com.sun.tools.javac.code.Symbol.MethodSymbol;
import openjdk.com.sun.tools.javac.comp.Annotate;
import openjdk.com.sun.tools.javac.comp.Annotate.Worker;
...
import openjdk.com.sun.tools.javac.tree.JCTree.JCLambda;
...
import openjdk.com.sun.tools.javac.tree.TreeScanner;
import openjdk.com.sun.tools.javac.tree.JCTree.*;
...
public class TypeAnnotations {
    ...
    private class TypeAnnotationPositions extends TreeScanner {
        ...
        // {@link openjdk.com.sun.tools.javac.parser.JavacParser.insertAnnotationsToMostInner(JCExpression, List<JCTypeAnnotation>, boolean)}
        ...
        private Type typeWithAnnotations(final JCTree typetree, final Type type,
            ...
            if (type.hasTag(TypeTag.ARRAY)) {
                ...
                // UnionClassType uct = (openjdk.com.sun.tools.javac.code.Type.UnionClassType)type;
        ...
        private void resolveFrame(JCTree tree, JCTree frame,
            ...
            */
            ...
            // openjdk.com.sun.tools.javac.jvm.Gen.setTypeAnnotationPositions(int)
