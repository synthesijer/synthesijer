...
import openjdk.com.sun.source.tree.CatchTree;
import openjdk.com.sun.source.tree.CompilationUnitTree;
import openjdk.com.sun.source.tree.Scope;
import openjdk.com.sun.source.tree.Tree;
import openjdk.com.sun.source.util.DocSourcePositions;
import openjdk.com.sun.source.util.DocTreePath;
import openjdk.com.sun.source.util.DocTreeScanner;
import openjdk.com.sun.source.util.DocTrees;
import openjdk.com.sun.source.util.JavacTask;
import openjdk.com.sun.source.util.TreePath;
...
import openjdk.com.sun.tools.javac.code.Symbol.ClassSymbol;
import openjdk.com.sun.tools.javac.code.Symbol.MethodSymbol;
import openjdk.com.sun.tools.javac.code.Symbol.PackageSymbol;
import openjdk.com.sun.tools.javac.code.Symbol.TypeSymbol;
import openjdk.com.sun.tools.javac.code.Symbol.VarSymbol;
import openjdk.com.sun.tools.javac.code.Type;
import openjdk.com.sun.tools.javac.code.Type.ArrayType;
import openjdk.com.sun.tools.javac.code.Type.ClassType;
import openjdk.com.sun.tools.javac.code.Type.ErrorType;
import openjdk.com.sun.tools.javac.code.Type.UnionClassType;
import openjdk.com.sun.tools.javac.code.Types;
import openjdk.com.sun.tools.javac.code.Types.TypeRelation;
import openjdk.com.sun.tools.javac.comp.Attr;
import openjdk.com.sun.tools.javac.comp.AttrContext;
import openjdk.com.sun.tools.javac.comp.Enter;
import openjdk.com.sun.tools.javac.comp.Env;
import openjdk.com.sun.tools.javac.comp.MemberEnter;
...
import openjdk.com.sun.tools.javac.tree.DCTree;
import openjdk.com.sun.tools.javac.tree.DCTree.DCBlockTag;
import openjdk.com.sun.tools.javac.tree.DCTree.DCDocComment;
import openjdk.com.sun.tools.javac.tree.DCTree.DCEndPosTree;
import openjdk.com.sun.tools.javac.tree.DCTree.DCErroneous;
import openjdk.com.sun.tools.javac.tree.DCTree.DCIdentifier;
import openjdk.com.sun.tools.javac.tree.DCTree.DCParam;
import openjdk.com.sun.tools.javac.tree.DCTree.DCReference;
import openjdk.com.sun.tools.javac.tree.DCTree.DCText;
import openjdk.com.sun.tools.javac.tree.EndPosTable;
import openjdk.com.sun.tools.javac.tree.JCTree;
import openjdk.com.sun.tools.javac.tree.JCTree.*;
import openjdk.com.sun.tools.javac.tree.TreeCopier;
import openjdk.com.sun.tools.javac.tree.TreeInfo;
import openjdk.com.sun.tools.javac.tree.TreeMaker;
import openjdk.com.sun.tools.javac.util.Abort;
...
import openjdk.com.sun.tools.javac.util.Position;
import static openjdk.com.sun.tools.javac.code.TypeTag.*;
...
public class JavacTrees extends DocTrees {
    ...
    private VarSymbol searchField(ClassSymbol tsym, Name fieldName, Set<ClassSymbol> searched) {
        ...
        for (openjdk.com.sun.tools.javac.code.Scope.Entry e = tsym.members().lookup(fieldName);
    ...
    /** @see openjdk.com.sun.tools.javadoc.ClassDocImpl#findConstructor */
    MethodSymbol findConstructor(ClassSymbol tsym, List<Type> paramTypes) {
        for (openjdk.com.sun.tools.javac.code.Scope.Entry e = tsym.members().lookup(names.init);
                e.scope != null; e = e.next()) {
    ...
    /** @see openjdk.com.sun.tools.javadoc.ClassDocImpl#findMethod */
    ...
    /** @see openjdk.com.sun.tools.javadoc.ClassDocImpl#searchMethod */
    private MethodSymbol searchMethod(ClassSymbol tsym, Name methodName,
        ...
        openjdk.com.sun.tools.javac.code.Scope.Entry e = tsym.members().lookup(methodName);
    ...
    /** @see openjdk.com.sun.tools.javadoc.ClassDocImpl */
    ...
    public boolean isAccessible(Scope scope, Element member, DeclaredType type) {
        if (scope instanceof JavacScope
                ...
                && type instanceof openjdk.com.sun.tools.javac.code.Type) {
            Env<AttrContext> env = ((JavacScope) scope).env;
            return resolve.isAccessible(env, (openjdk.com.sun.tools.javac.code.Type)type, (Symbol)member, true);
        } else
            return false;
    }
...
//                    System.err.println("DEFAULT: " + tree.getKind());
    ...
    public TypeMirror getOriginalType(javax.lang.model.type.ErrorType errorType) {
        if (errorType instanceof openjdk.com.sun.tools.javac.code.Type.ErrorType) {
            return ((openjdk.com.sun.tools.javac.code.Type.ErrorType)errorType).getOriginalType();
        }

        return openjdk.com.sun.tools.javac.code.Type.noType;
    }
    ...
    public void printMessage(Diagnostic.Kind kind, CharSequence msg,
            openjdk.com.sun.source.tree.Tree t,
            openjdk.com.sun.source.tree.CompilationUnitTree root) {
        printMessage(kind, msg, ((JCTree) t).pos(), root);
    }

    public void printMessage(Diagnostic.Kind kind, CharSequence msg,
            openjdk.com.sun.source.doctree.DocTree t,
            openjdk.com.sun.source.doctree.DocCommentTree c,
            openjdk.com.sun.source.tree.CompilationUnitTree root) {
