...
import openjdk.com.sun.source.tree.IdentifierTree;
import openjdk.com.sun.source.tree.MemberReferenceTree.ReferenceMode;
import openjdk.com.sun.source.tree.MemberSelectTree;
import openjdk.com.sun.source.tree.TreeVisitor;
import openjdk.com.sun.source.util.SimpleTreeVisitor;
import openjdk.com.sun.tools.javac.code.*;
import openjdk.com.sun.tools.javac.code.Lint.LintCategory;
...
import static openjdk.com.sun.tools.javac.code.Flags.ANNOTATION;
...
import static openjdk.com.sun.tools.javac.code.TypeTag.WILDCARD;
...
//                             Resolve.isStatic(env));//DEBUG
    ...
    private final class TypeAnnotationsValidator extends TreeScanner {
         ...
         * openjdk.com.sun.tools.javac.comp.Check.Validator.visitSelectInternal(JCFieldAccess)
