...
import openjdk.com.sun.tools.javac.file.RelativePath.RelativeDirectory;
import openjdk.com.sun.tools.javac.file.RelativePath.RelativeFile;
...
public class ZipFileIndex {
     ...
     */
    public synchronized openjdk.com.sun.tools.javac.util.List<String> getFiles(RelativeDirectory path) {
        try {
            checkIndex();

            DirectoryEntry de = directories.get(path);
            openjdk.com.sun.tools.javac.util.List<String> ret = de == null ? null : de.getFiles();
   ...
   */
    ...
    static class DirectoryEntry {
        ...
        private openjdk.com.sun.tools.javac.util.List<String> zipFileEntriesFiles = openjdk.com.sun.tools.javac.util.List.<String>nil();
        private openjdk.com.sun.tools.javac.util.List<String> zipFileEntriesDirectories = openjdk.com.sun.tools.javac.util.List.<String>nil();
        private openjdk.com.sun.tools.javac.util.List<Entry>  zipFileEntries = openjdk.com.sun.tools.javac.util.List.<Entry>nil();
