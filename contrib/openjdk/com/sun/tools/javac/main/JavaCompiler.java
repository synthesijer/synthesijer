...
import openjdk.com.sun.source.util.TaskEvent;
import openjdk.com.sun.source.util.TaskListener;
...
import openjdk.com.sun.tools.javac.parser.*;
import openjdk.com.sun.tools.javac.comp.*;
import openjdk.com.sun.tools.javac.jvm.*;
import openjdk.com.sun.tools.javac.processing.*;

import static javax.tools.StandardLocation.CLASS_OUTPUT;
import static openjdk.com.sun.tools.javac.main.OptionName.*;
import static openjdk.com.sun.tools.javac.util.JCDiagnostic.DiagnosticFlag.*;
import static openjdk.com.sun.tools.javac.util.ListBuffer.lb;
...
public class JavaCompiler implements ClassReader.SourceCompleter {
    ...
    private static final String versionRBName = "openjdk.com.sun.tools.javac.resources.version";
...
//        net.wasamon.javarock.tools.Manager.INSTANCE.connectionAll();
//        net.wasamon.javarock.tools.Manager.INSTANCE.bypassAll();
//        net.wasamon.javarock.tools.Manager.INSTANCE.optimizationAll();
//        net.wasamon.javarock.tools.Manager.INSTANCE.linkageAll();
//        net.wasamon.javarock.tools.Manager.INSTANCE.generateAll();
//        synthesijer.Manager.INSTANCE.generate();
    }
   ...
   public List<JCCompilationUnit> parseFiles(Iterable<JavaFileObject> fileObjects) {
    ...
    public static void enableLogging() {
        Logger logger = Logger.getLogger(openjdk.com.sun.tools.javac.Main.class.getPackage().getName());
