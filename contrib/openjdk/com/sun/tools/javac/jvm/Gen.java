...
import openjdk.com.sun.tools.javac.jvm.Items.*;
...
import static openjdk.com.sun.tools.javac.jvm.ByteCodes.*;
import static openjdk.com.sun.tools.javac.jvm.CRTFlags.*;
import static openjdk.com.sun.tools.javac.main.Option.*;
 ...
 *************************************************************************/
    ...
    private void setTypeAnnotationPositions(int treePos) {
        ...
        for (Symbol s : new openjdk.com.sun.tools.javac.model.FilteredMemberList(clazz.members())) {
